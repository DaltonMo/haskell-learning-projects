...
/* package todo-list-app-0.1.0.0 */
#ifndef VERSION_todo_list_app
#define VERSION_todo_list_app "0.1.0.0"
#endif /* VERSION_todo_list_app */
#ifndef MIN_VERSION_todo_list_app
#define MIN_VERSION_todo_list_app(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_todo_list_app */
...
#define CURRENT_COMPONENT_ID "todo-list-app-0.1.0.0-inplace-todo-list-app"
